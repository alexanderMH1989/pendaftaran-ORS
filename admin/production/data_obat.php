                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php
                        $data = mysqli_query($koneksi,"SELECT * FROM data_obat");
                        $no=1;
                        ...
                        <?php
                        // echo "<td>".$no++."</td>";
                        echo "<td>".$pendidikan['id_obat']."</td>";
                        echo "<td>".$pendidikan['nama_obat']."</td>";
                        echo "<td>".$pendidikan['jenis_obat']."</td>";
                        echo "<td>".$pendidikan['stok_obat']."</td>";
                        echo "<td>".$pendidikan['harga_obat']."</td>";
                        // echo "<td>".$pendidikan['tanggal_lahir']."</td>";
                        
                        ?>
                        <td>
                            <div class="table-data-feature">
                            <a href="form_edit_obat.php?id_obat=<?php echo $pendidikan['id_obat'];?>">
                              <button type="submit" class="btn btn-success">Edit</button>
                            <i class="zmdi zmdi-edit"></i>
                             </button></a>&nbsp;
                            <a href="proses_hapus_obat.php?id_obat=<?php echo $pendidikan['id_obat'];?>">
