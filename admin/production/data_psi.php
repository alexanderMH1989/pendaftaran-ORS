...
<html lang="en">
  <head>
    ...
    <title>Data Pelatihan Sumber Informasi</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Data Penelusuran Sumber Informasi <!-- <small>Some examples to get you started</small> --></h3>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php
                        $data = mysqli_query($koneksi,"SELECT * FROM data_pagi");
                        $no=1;
                        ...
                        echo "<td>".$pendidikan['nim']."</td>";
                          ...
                          // echo "<td>".$pendidikan['email']."</td>";
                          echo "<td>".$pendidikan['no_wa']."</td>";
                        
                        ?>
                        <td>
                            <div class="table-data-feature">
                            <a href="form_edit_psi.php?nim=<?php echo $pendidikan['nim'];?>">
                              <button type="submit">Edit</button>
                            
                             </button></a>&nbsp;
                            <a href="proses_hapus_psi.php?nim=<?php echo $pendidikan['nim'];?>">
