            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="proses_tambah_pembelian.php" method="post" enctype="multipart/form-data">
...
$query = mysqli_query($koneksi,"SELECT id_pembelian FROM data_pembelian ORDER BY id_pembelian DESC");
...
if(strlen($tambah)==1){
  $id = "PB".$bulan.$tahun."00".$tambah;
}else if (strlen($tambah)==2){
  $id = "PB".$bulan.$tahun."0".$tambah;
}else{
   $id = "PB".$bulan.$tahun.$tambah;
}
?>
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Supplier 
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="jumlah" name="supllier" class="form-control" >
                        </div>
                      </div>
