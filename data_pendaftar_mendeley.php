...
<body>
  ...
  <div class="site-wrap">
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="data_pendaftar_zotero.php" class="nav-link">Zotero</a></li>
    ...
    <main id="main">
            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  <h1 data-aos="fade-up" data-aos-delay="">Reference Management Tools (Mendeley)</h1>
      ...
      <div class="container">
         <form action="data_pendaftar_mendeley.php" enctype="multipart/form-data" method="post" >
            <div class="col-md-12 form-group">
                      ...
                      <div class="col-md-6 form-group">
                          <select class="form-control" name="tanggal" >
                            ...
                            <?php
                            include 'koneksi.php';
                            $sql="SELECT distinct tanggal from data_mendeley ORDER By tanggal ASC";
         ...
         <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      <tbody>
                        ...
                        <tr>
                            ...
                            if(isset($_POST['cari'])){
                              $cari = $_POST['tanggal'];
                              $data = mysqli_query($koneksi,"SELECT nim, nama, jurusan, semester, gender, tanggal FROM data_mendeley WHERE tanggal like '%".$cari."%'"); 
                              $no = 1;
