...
<body>
  ...
  <div class="site-wrap">
    ...
    <main id="main">
            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  <h1 data-aos="fade-up" data-aos-delay="">Penelusuran Sumber Informasi</h1>
      ...
      <div class="container">
         <form action="data_pendaftar_pagi.php" enctype="multipart/form-data" method="post" >
            <div class="col-md-12 form-group">
                      ...
                      <div class="col-md-6 form-group">
                          <select class="form-control" name="tanggal" >
                            ...
                            <?php
                            include 'koneksi.php';
                            $sql="SELECT distinct tanggal from data_pagi ORDER By tanggal ASC";
         ...
         <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      <tbody>
                        ...
                        <tr>
                            ...
                            if(isset($_POST['cari'])){
                              $cari = $_POST['tanggal'];
                              $data = mysqli_query($koneksi,"SELECT nim, nama, jurusan, semester, gender, tanggal FROM data_pagi WHERE tanggal like '%".$cari."%'"); 
                              $no = 1;
