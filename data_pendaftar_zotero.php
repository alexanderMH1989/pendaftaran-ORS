...
<body>
  ...
  <div class="site-wrap">
    ...
    <main id="main">
            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  <h1 data-aos="fade-up" data-aos-delay="">Reference Management Tools (Zotero)</h1>
                  <p class="mb-5" data-aos="fade-up"  data-aos-delay="100">Pelatihan Sesi Pagi (09.00-11.00 WIB)</p>  
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
         <form action="data_pendaftar_zotero.php" enctype="multipart/form-data" method="post" >
            <div class="col-md-12 form-group">
                      ...
                      <div class="col-md-6 form-group">
                          <select class="form-control" name="tanggal" >
                            ...
                            <?php
                            include 'koneksi.php';
                            $sql="SELECT distinct tanggal from data_zotero ORDER By tanggal ASC";
         ...
         <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      <tbody>
                        ...
                        <tr>
                            ...
                            if(isset($_POST['cari'])){
                              $cari = $_POST['tanggal'];
                              $data = mysqli_query($koneksi,"SELECT nim, nama, jurusan, semester, gender, tanggal FROM data_zotero WHERE tanggal like '%".$cari."%'"); 
                              $no = 1;
