...
<?php
include 'koneksi.php';
include 'proses_daftar_siang.php';
?>
<head>
  <meta charset="utf-8">
        ...
        <?php endif; ?>
            ...
            <div class="row">
              <div class="col-md-10 mb-5 mb-md-0" >
                <form action="form_daftar_siang.php" enctype="multipart/form-data" method="post" >
              
                  <div class="row">
                    
                    <div class="col-md-12 form-group" <?php if (isset($tnim_error)): ?>  <?php endif ?>>>
                    ...
                    <div class="col-md-12 form-group">     
                      <label for="name" class="warna_huruf">Tanggal Pelatihan *</label> <small class="huruf_merah">Pilih Tanggal di Hari Selasa Saja</small>
                      <input type="date" min="2020-02-25" step="7" class="form-control" onfocus="(this.type='date')" name="tanggal" id="tanggal"  required="required" value="<?php echo $tanggal; ?>"/>
                    </div>
